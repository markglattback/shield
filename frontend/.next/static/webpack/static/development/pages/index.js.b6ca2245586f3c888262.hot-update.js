            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  pathname = ctx.pathname, query = ctx.query; // const returnPath = `?path=${pathName}${query}`;

                  console.log('pathname: ', pathname, 'query: ', query); // SSR auth check only takes place on initial page load
...
//# sourceMappingURL=index.js.b6ca2245586f3c888262.hot-update.js.map